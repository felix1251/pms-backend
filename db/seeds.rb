...
users.each do |user|
      ...
      UserPageAccess.create(user_id: user.id, page_access_id: 5, status: "A")
      UserPageAccess.create(user_id: user.id, page_access_id: 6, status: "A")
...
time_keeping.each do |tk|
      ...
      UserPageAccess.create(user_id: tk.id, page_access_id: 5, status: "I")
      UserPageAccess.create(user_id: tk.id, page_access_id: 6, status: "I")
      ...
      UserPageActionAccess.create(user_id: tk.id, page_access_id: 5, page_action_access_id: 1, status: "I")
      UserPageActionAccess.create(user_id: tk.id, page_access_id: 5, page_action_access_id: 2, status: "I")
      UserPageActionAccess.create(user_id: tk.id, page_access_id: 5, page_action_access_id: 3, status: "I")
      UserPageActionAccess.create(user_id: tk.id, page_access_id: 5, page_action_access_id: 4, status: "I")
...
payroll.each do |pr|
      ...
      UserPageAccess.create(user_id: pr.id, page_access_id: 5, status: "I")
      UserPageAccess.create(user_id: pr.id, page_access_id: 6, status: "I")
